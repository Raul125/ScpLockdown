...
public sealed class Config : IConfig
{
    ...
    public List<ScpLocker> AffectedScps { get; private set; } = new()
    {
    ...
    public List<AffectedDoor> AffectedDoors { get; private set; } = new()
    {
    ...
    public List<CassieAnnouncement> Cassies { get; private set; } = new()
    {
